...
const AdminHeader = ({
  ...
  return (
    <header
      className="h-24 mt-4 mx-4 transition-shadow hover:shadow-2xl duration-300 px-8 hidden md:flex items-center justify-between rounded-2xl shadow-l"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 text-white flex items-center justify-center hover:bg-white/20 hover:scale-110 active:scale-95 transition-all duration-300"
        >
          <FiMenu />
        </button>
